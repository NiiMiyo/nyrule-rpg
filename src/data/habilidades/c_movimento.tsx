	...
	aprimoramentos: [{
		...
		descricao: <>
			...
			<ListaTopicos tipoDeLista="p" ordenar topicos={[{
				titulo: "Aéreo (+4 XP)",
				texto: `Quando ${A_ANDAR.nome} pode usar uma de suas unidades de movimento para se deslocar uma unidade na vertical, para cima ou para baixo. Sempre que terminar seu turno fora do chão você gastar 1 PE. Durante seu turno você também pode cair em queda livre a qualquer momento sem gastar uma Ação.`
			}, {

...
export const HABILIDADES_DADOS = gerar_lista_habilidades([
	H_APRENDER, H_PASSO_LIGEIRO, H_CONTRA_ATAQUE, H_TRANSFORMACAO_DE_BATALHA, H_PROTEGER, H_ROLAMENTO, H_AUMENTO_PV, H_AUMENTO_PE, C_MEMBROS, C_VISAO, C_MOVIMENTO, C_METABOLISMO, H_APRENDER_MAGIA, H_AO_ACASO,
]);

export default function Page_Testes() {
	return <main>
		...
		<p>
			...
			costuma somar o valor um Conhecimento em cada teste.
		</p>
		<p>
			A maioria dos testes envolve alcançar uma Meta. Isto é, ao rolar o
			dado, somar os bônus e subtrair as penalidades o valor alcançado
		...
		<p>
			Em certas situações, algumas ações podem ser favorecidas ou
			prejudicadas. Por exemplo, atirar em um oponente próximo não é uma
		...
		<p>
			...
			resultado. A maioria dos bônus se enquadra nessa categoria. Situações
			particularmente simples e fáceis, como caminhar em uma superfície plana
			ou enxergar alguém diretamente a sua frente, dão grandes bônus ao
			teste, como +15 ou um sucesso automático.
		</p>
		<p>
